...
- [ ] Темная тема
- [ ] Интернационализация
- [ ] Интересные факты о стране при нажатии на флаг
- [x] Реализовать вручную алгоритм Дамерау-Левенштейна
- [ ] Добавить ручку для получения статистик: сколько стран к кэше загружено, сколько имён и т.д.
